...
<body >
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <h1 class="page-header" style="font-family: Algerian, Helvetica, sans-serif; ">
            ...
            <div style="margin-bottom: 10%"  >
                <div class="well">
                  <marquee><img src="img/labur_chor-1.jpg" alt="Chania" style="width: 80%; margin: 0% 0% 0% 8%;"></marquee> 
                </div>
            </div>
 ...
 <div style="text-align: center;">
  <h1>Photographers Speach</h1>;
 </div>
 <div>
     <img src="">
     <h3>1.A good photograph is knowing where to stand.</h3>
     <h3>2.There are always two people in every picture: the photographer and the viewer.</h3>
     <h3>3.You don't take a photograph, you make it.</h3>
     <h3>4.There are no rules for good photographs, there are only good photographs.</h3>
     <h3>5.If your pictures aren't good enough, you're not close enough.</h3>
